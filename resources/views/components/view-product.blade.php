                ...
                <div class="md:py-8">
                    ...
                    <div class="mb-4">
                        <div class="flex items-end gap-2">
                            <span class="text-xl font-bold text-gray-800 md:text-2xl">Kes {{ number_format($product->retail_price, 2) }}</span>
                            <span class="mb-0.5 text-red-500 line-through">Kes {{ number_format($product->list_price, 2) }}</span>
                        </div>
